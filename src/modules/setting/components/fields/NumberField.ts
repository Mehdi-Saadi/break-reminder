...
import SquareAddButton from '@/modules/setting/components/buttons/SquareAddButton.ts';
import SquareRemoveButton from '@/modules/setting/components/buttons/SquareRemoveButton.ts';
